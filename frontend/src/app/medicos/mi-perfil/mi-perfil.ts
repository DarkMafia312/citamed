...
export class MiPerfil implements OnInit {
  ...
  cargarPerfil(): void {
    ...
    this.medicoService.obtenerMiPerfil().subscribe({
      next: (medico) => {
        ...
        this.especialidadNombre = medico.especialidadNombre || '-';
        this.cmpActual = medico.cmp || '-';
        this.usernameActual = medico.username || '-';
  ...
  onSubmit(): void {
    ...
    this.medicoService.actualizarMiPerfil(this.medicoId!, data).subscribe({
      next: () => {
